...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '6df53848-2fc0-488f-9271-d3a770c91d92' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('5827fe80-7e81-47cf-9612-81c351a4f5e5');
      cy.get(`[data-cy="name"]`).should('have.value', '5827fe80-7e81-47cf-9612-81c351a4f5e5');
